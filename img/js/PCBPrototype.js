$(function () {
  ...
  $('.js-build-box div').click(function () {
    $(this).addClass('active').siblings().removeClass('active is-free');
    if ($(this).find('.logo-note').length > 0) {
      $(this).addClass('is-free')
    }
  });
...
//    5.3
  ...
  $('.js-dropdown4').click(function () {
    $(this).children('.js-dropdown-ul4').show();
    $('.js-dropdown-ul4>li').click(function (e) {
      $('.js-dropdown-input4').val($.trim($(this).html()));
      $('.js-dropdown-ul4').hide();
      e.stopPropagation();
    });
  });
  $('.js-dropdown4').mouseleave(function () {
    $(this).children('.js-dropdown-ul4').hide();
  });
//    第一项
//    layers事件
